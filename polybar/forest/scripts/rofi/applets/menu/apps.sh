...
style="$($HOME/.config/polybar/forest/scripts/rofi/applets/menu/style.sh)"

dir="$HOME/.config/polybar/forest/scripts/rofi/applets/menu/configs/$style"
...
# Error msg
msg() {
	rofi -theme "$HOME/.config/polybar/forest/scripts/rofi/applets/styles/message.rasi" -e "$1"
}
